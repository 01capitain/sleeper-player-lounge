 ...
 *
 * Sleeper parks undrafted players at a 1000 sentinel. The builder drops those,
 * so a player absent from the artifact is genuinely UNRANKED — never a huge
 * number that would read as a 900-pick fall.
 */
